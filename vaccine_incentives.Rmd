...
vi_bal_tab_1to1 <- bal.tab(vi_m.out.1to1, treat = vi_data1$treated, covs = vi_X_1, thresholds = c(m = 0.1), un = TRUE)
vi_bal_tab_1to1
```
```{r Love plot of 1:1 dm}
vi_lp.1to1 <- love.plot(
  vi_m.out.1to1,
  threshold = .1,
  binary = 'std',
  treat = vi_data1$treated,
...
vi_bal_tab_1to2 <- bal.tab(vi_m.out.1to2, treat = vi_data1$treated, covs = vi_X_1, thresholds = c(m = 0.1), un = TRUE)
vi_bal_tab_1to2
```
```{r Love plot of 1:2 dm}
vi_lp.1to2 <- love.plot(
  vi_m.out.1to2,
  threshold = .1,
  binary = 'std',
  treat = vi_data1$treated,
...
vi_bal_tab_1to3 <- bal.tab(vi_m.out.1to3, treat = vi_data1$treated, covs = vi_X_1, thresholds = c(m = 0.1), un = TRUE)
vi_bal_tab_1to3
```
```{r Love plot of 1:3 dm}
vi_lp.1to3 <- love.plot(
  vi_m.out.1to3,
  threshold = .1,
  binary = 'std',
  treat = vi_data1$treated,
