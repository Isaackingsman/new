...
summary(model_em_2)
```
### Comparing Basic regression and control regression
```{r Generating em basic and control regression results, message=FALSE, warning=FALSE}
# export regression result
stargazer(model_em1_1, model_em_2, 
          type="text",
          title= "Basic regression and control regression results",
          intercept.bottom = F,
          intercept.top = T,
          digits=4)
```
```{r Generating em basic and control regression results .doc, message=FALSE, warning=FALSE, include=FALSE}
# export regression result
stargazer(model_em1_1, model_em_2, 
          type="html",
          title="Basic regression and control regression results",
          out="Basic_regression_and_control_regression_results.doc",
          intercept.bottom = F,
          intercept.top = T,
          digits=4)
```
